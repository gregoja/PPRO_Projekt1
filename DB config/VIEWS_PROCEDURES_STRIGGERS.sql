...
AS
SELECT `ORDER_ID`, `CITY`, `EMAIL`, `FIRSTANAME`, `HOUSE_NUMBER`, `LASTNAME`, `STREET`, `TEL_NUMBER`, `ZIP_CODE`, states.NAME as "STATE", `PHONE_PREFIX`, `USER_ID`, `ORDERED` FROM `orders` NATURAL JOIN states WHERE orders.COMPLETED LIKE 0 ORDER BY 1;
